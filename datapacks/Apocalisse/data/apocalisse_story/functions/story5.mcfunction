...
##Story 5
execute at @a[scores={ApocalisseStory5=1..}] run scoreboard objectives add SpawnpointStory5 dummy
...
execute at @a[scores={ApocalisseStory5=21}] run scoreboard players set @a ApocalisseWeapon 2
