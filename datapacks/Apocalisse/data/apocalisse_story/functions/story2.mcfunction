...
##Mob Spawn
execute at @a[scores={ApocalisseStory2=96}] run summon minecraft:skeleton -136.41 22.00 -110.52 {PersistenceRequired:1b,HandItems:[{id:"minecraft:stone_sword",Count:1b},{}],HandDropChances:[0.000F,0.085F],ActiveEffects:[{Id:12b,Amplifier:250,Duration:100,ShowParticles:0b}]}
execute at @a[scores={ApocalisseStory2=96}] run summon minecraft:skeleton -127.91 22.00 -120.20 {PersistenceRequired:1b,HandItems:[{id:"minecraft:stone_sword",Count:1b},{}],HandDropChances:[0.000F,0.085F],ActiveEffects:[{Id:12b,Amplifier:250,Duration:100,ShowParticles:0b}]}
execute at @a[scores={ApocalisseStory2=96}] run summon minecraft:skeleton -135.53 26.94 -103.00 {PersistenceRequired:1b,HandItems:[{id:"minecraft:bow",Count:1b},{}],HandDropChances:[0.000F,0.085F],ActiveEffects:[{Id:12b,Amplifier:250,Duration:100,ShowParticles:0b}]}
execute at @a[scores={ApocalisseStory2=96}] run summon minecraft:skeleton -201.42 21.94 -109.00 {PersistenceRequired:1b,HandItems:[{id:"minecraft:bow",Count:1b},{}],HandDropChances:[0.000F,0.085F],ActiveEffects:[{Id:12b,Amplifier:250,Duration:100,ShowParticles:0b}]}
...
execute at @a[scores={ApocalisseStory2=96}] run summon minecraft:skeleton -138.42 26.89 -122.00 {PersistenceRequired:1b,HandItems:[{id:"minecraft:stone_sword",Count:1b},{}],HandDropChances:[0.000F,0.085F],ActiveEffects:[{Id:12b,Amplifier:250,Duration:100,ShowParticles:0b}]}
